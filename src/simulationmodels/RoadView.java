 ...
 */
public class RoadView implements StraightLinesShapeInterface {
     ...
     */
    public RoadView(Double roadLength, Double laneWidth, Integer totalLanesNum, Orientation orientation, Point2D leftUpperCorner) {
